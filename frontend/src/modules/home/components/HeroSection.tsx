...
export function HeroSection({ title, subtitle, primaryLabel, secondaryLabel, stats }: HeroSectionProps) {
  return (
    <section className="rounded-[32px] bg-slate-950 bg-[radial-gradient(circle_at_15%_20%,rgba(56,189,248,0.35),transparent_40%),radial-gradient(circle_at_85%_0%,rgba(168,85,247,0.35),transparent_45%)] px-6 py-10 text-white shadow-xl sm:px-10">
