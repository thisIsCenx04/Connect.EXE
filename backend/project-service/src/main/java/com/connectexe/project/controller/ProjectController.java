...
public class ProjectController {
    ...
    public ResponseEntity<ApiResponse<List<ProjectResponse>>> list(
        ...
        ProjectModerationStatus effectiveModeration = moderationStatus == null ? ProjectModerationStatus.APPROVED
                : moderationStatus;
        ProjectVisibility effectiveVisibility = visibility == null ? ProjectVisibility.PUBLIC : visibility;
